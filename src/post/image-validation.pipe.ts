...
export class ImageValidationPipe implements PipeTransform {
  // створюємо клас імплементуючи інтерфейс PipeTransform
